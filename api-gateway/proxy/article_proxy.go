...
func (p *ArticleProxy) GetArticle(c *gin.Context) {
	p.proxyRequestWithoutHMAC(c, "/articles/"+c.Param("id"), nil)
}
...
func (p *ArticleProxy) ListArticles(c *gin.Context) {
	p.proxyRequestWithoutHMAC(c, "/articles", nil)
}
...
func (p *ArticleProxy) SearchArticles(c *gin.Context) {
	p.proxyRequestWithoutHMAC(c, "/articles/search", nil)
}
...
// proxyRequest proxies a request to the Article service
func (p *ArticleProxy) proxyRequestWithoutHMAC(c *gin.Context, path string, transformRequestBody func([]byte) ([]byte, error)) {
	targetURL := p.baseURL + path
